    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center p-8 bg-white rounded-xl shadow-lg">
          ...
          <p className="mt-2 text-gray-600">{error?.data?.message || 'Failed to load profile. Please make sure you are logged in as a doctor.'}</p>
          <button
  ...
  return (
    <ProfileLayout
      ...
      actions={
        <>
          {profile?.verificationStatus !== 'VERIFIED' && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg px-4 py-2 text-sm text-yellow-800 flex items-center">
              <span className="mr-2">⚠️</span> Verification Pending
            </div>
          )}
