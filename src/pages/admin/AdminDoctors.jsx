 ...
 * Full implementation for managing doctors in admin role
 */
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium ${view === 'all'
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium ${view === 'pending'
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium ${view === 'expiring'
